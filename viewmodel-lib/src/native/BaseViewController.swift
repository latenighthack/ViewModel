...
class BaseViewController<ViewModelType : ViewModel, StateType>: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.watchCloseable = viewModel.state.watch { [weak self] (state: StateType) in
        ...
        self.onStateChanged(viewModel: self.viewModel, state: self.viewModel.initialState as! StateType)
    }
